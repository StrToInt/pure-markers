	...
	
	{
		...
		"markers" : {
			"pure_end" : [
				...
				{"p1" : [+56, -77, 75], "p2" : [+0615,  -800, 69],"color" : "#00FF00","text" : "<b>Путь гейта N+2</b><br>[Новые земли]</br>"},
				{"p1" : [+96, +00, 75], "p2" : [+0767,    -1, 40],"color" : "#00FF00","text" : "<b>Путь гейта E+0</b><br>[Ферма житаков]</br>"},
				{"p1" : [+00, +96, 75], "p2" : [-0016, +1007, 69],"color" : "#00FF00","text" : "<b>Путь гейта S+0</b><br>[Новые земли]</br>"},
				{"p1" : [-96, +00, 75], "p2" : [-0773,    -3, 85],"color" : "#00FF00","text" : "<b>Путь гейта W+0</b><br>[Ферма эндерменов]</br>"},
			],
		},
	},{
		"id" : "traces",
